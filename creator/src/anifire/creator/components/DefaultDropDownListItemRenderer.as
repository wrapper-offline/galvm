package anifire.creator.components
{
	...
	public class DefaultDropDownListItemRenderer extends ItemRenderer implements IBindingClient, IStateClient2
	{
		...
		{
			var watchers:Array;
			var _DefaultDropDownListItemRenderer_Rect1_factory:DeferredInstanceFromFunction;
			var i:uint;
			...
			_DefaultDropDownListItemRenderer_Rect1_factory = new DeferredInstanceFromFunction(this._DefaultDropDownListItemRenderer_Rect1_i);
			states = [new State({
				"name":"normal",
				"overrides":[]
			}),new State({
