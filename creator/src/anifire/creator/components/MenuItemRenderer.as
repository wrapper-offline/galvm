package anifire.creator.components
{
	...
	public class MenuItemRenderer extends ItemRenderer implements IBindingClient, IStateClient2
	{
		...
		public function MenuItemRenderer()
		{
			var bindings:Array;
			var watchers:Array;
			var _MenuItemRenderer_Rect1_factory:DeferredInstanceFromFunction;
			var i:uint;
			...
			bindings = this._MenuItemRenderer_bindingsSetup();
			watchers = [];
			target = this;
			...
			_MenuItemRenderer_Rect1_factory = new DeferredInstanceFromFunction(this._MenuItemRenderer_Rect1_i);
			states = [new State({
				"name":"normal",
				"overrides":[]
			}),new State({
