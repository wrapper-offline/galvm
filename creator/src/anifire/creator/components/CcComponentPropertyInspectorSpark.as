package anifire.creator.components
{
	...
	public class CcComponentPropertyInspectorSpark extends Group implements IBindingClient, IStateClient2
	{
		...
		public function CcComponentPropertyInspectorSpark()
		{
			var bindings:Array;
			var watchers:Array;
			var _CcComponentPropertyInspectorSpark_VGroup1_factory:DeferredInstanceFromFunction;
			var _CcComponentPropertyInspectorSpark_VGroup2_factory:DeferredInstanceFromFunction;
			var _CcComponentPropertyInspectorSpark_VGroup3_factory:DeferredInstanceFromFunction;
			var i:uint;
			...
			bindings = this._CcComponentPropertyInspectorSpark_bindingsSetup();
			watchers = [];
			target = this;
			...
			_CcComponentPropertyInspectorSpark_VGroup1_factory = new DeferredInstanceFromFunction(this._CcComponentPropertyInspectorSpark_VGroup1_i);
			_CcComponentPropertyInspectorSpark_VGroup2_factory = new DeferredInstanceFromFunction(this._CcComponentPropertyInspectorSpark_VGroup2_i);
			_CcComponentPropertyInspectorSpark_VGroup3_factory = new DeferredInstanceFromFunction(this._CcComponentPropertyInspectorSpark_VGroup3_i);
			states = [new State({
				"name":"keep_pro",
