package anifire.creator.skins
{
	...
	public class ConfirmPanelSkin extends SparkSkin implements IBindingClient, IStateClient2
	{
		...
		{
			var watchers:Array;
			var _ConfirmPanelSkin_Group4_factory:DeferredInstanceFromFunction;
			var i:uint;
			...
			_ConfirmPanelSkin_Group4_factory = new DeferredInstanceFromFunction(this._ConfirmPanelSkin_Group4_i);
			states = [new State({
				"name":"normal",
