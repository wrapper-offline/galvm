package anifire.creator.skins
{
	...
	public class FlatColorPickerSkin extends SparkSkin implements IBindingClient, IStateClient2
	{
		...
		public function FlatColorPickerSkin()
		{
			var bindings:Array;
			var watchers:Array;
			var _FlatColorPickerSkin_PopUpAnchor1_factory:DeferredInstanceFromFunction;
			var i:uint;
			...
			bindings = this._FlatColorPickerSkin_bindingsSetup();
			watchers = [];
			target = this;
			...
			_FlatColorPickerSkin_PopUpAnchor1_factory = new DeferredInstanceFromFunction(this._FlatColorPickerSkin_PopUpAnchor1_i,this._FlatColorPickerSkin_PopUpAnchor1_r);
			states = [new State({
				"name":"normal",
		...
		private function _FlatColorPickerSkin_PopUpAnchor1_r() : void
		{
			...
			this._FlatColorPickerSkin_Group2 = null;
			this.transparentColorButton = null;
			this.dataGroup = null;
		}
