package anifire.creator.skins
{
	...
	public class DefaultDropDownListSkin extends SparkSkin implements IBindingClient, IStateClient2
	{
		...
		{
			var watchers:Array;
			var _DefaultDropDownListSkin_PopUpAnchor1_factory:DeferredInstanceFromFunction;
			var i:uint;
			...
			_DefaultDropDownListSkin_PopUpAnchor1_factory = new DeferredInstanceFromFunction(this._DefaultDropDownListSkin_PopUpAnchor1_i,this._DefaultDropDownListSkin_PopUpAnchor1_r);
			states = [new State({
				"name":"normal",
