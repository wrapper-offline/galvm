package anifire.creator.skins
{
	...
	public class ActionDropDownListSkin extends SparkSkin implements IBindingClient, IStateClient2
	{
		...
		{
			var watchers:Array;
			var _ActionDropDownListSkin_PopUpAnchor1_factory:DeferredInstanceFromFunction;
			var i:uint;
			...
			_ActionDropDownListSkin_PopUpAnchor1_factory = new DeferredInstanceFromFunction(this._ActionDropDownListSkin_PopUpAnchor1_i,this._ActionDropDownListSkin_PopUpAnchor1_r);
			states = [new State({
				"name":"normal",
