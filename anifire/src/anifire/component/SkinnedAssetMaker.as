package anifire.component
{
	...
	public class SkinnedAssetMaker extends Sprite implements ICharacter
	{
		...
		{
			var _loc2_:Boolean = this._demoSpeech != param1;
		...
		public function onReady(param1:Event = null) : void
		{
			...
			{
				_loc3_ = new SelectedColor(_loc2_.@r,String(_loc2_.@oc).length == 0 ? uint.MAX_VALUE : uint(_loc2_.@oc),uint(_loc2_));
		...
		public function speak(param1:Number) : void
		{
			...
			if(Boolean(this._lipSync) && Boolean(this._lipSyncMouthLoader) && Boolean(MovieClip(this._lipSyncMouthLoader.content)))
			{
