package anifire.browser.models
{
	...
	public class ActionExplorerCollection extends ProductGroupCollection
	{
		...
		public var searchResult:anifire.browser.models.SearchActionCollection;
		
		public var basicActions:anifire.browser.models.ProductCollection;
		...
		public function ActionExplorerCollection()
		{
			...
			this.searchResult = new anifire.browser.models.SearchActionCollection("Search Result");
		...
		override public function addProduct(param1:ThumbModel, param2:Boolean = true) : Boolean
		{
			...
			var _loc4_:anifire.browser.models.ProductCollection = !!_loc3_.categoryName ? this.getCategoryCollection(_loc3_.categoryName) : this.basicActions;
		...
		protected function getCategoryCollection(param1:String) : anifire.browser.models.ProductCollection
		{
			var _loc2_:anifire.browser.models.ProductCollection = this.categoryList[param1];
			if(!_loc2_)
			{
		...
		override public function getCategoryByProductId(param1:String) : anifire.browser.models.ProductCollection
		{
			return this.productCategoryLookup[param1];
		}
		
		override protected function registerProductCollection(param1:ThumbModel, param2:anifire.browser.models.ProductCollection) : void
		{
		...
		override public function removeAllProducts() : void
		{
			...
			source = [];
			collections = new Vector.<anifire.browser.models.ProductCollection>();
			this.categoryList = {};
			this.productCategoryLookup = {};
