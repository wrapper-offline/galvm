package anifire.browser.managers
{
	import anifire.browser.models.ActionExplorerCollection;
	import anifire.browser.models.CharacterActionCache;
	import flash.display.BitmapData;
	
	public class ImageDataManager
	{
		
		protected static var _instance:anifire.browser.managers.ImageDataManager;
		...
		public static function get instance() : anifire.browser.managers.ImageDataManager
		{
			if(_instance == null)
			{
				_instance = new anifire.browser.managers.ImageDataManager();
			}
			return _instance;
		}
