package anifire.browser.core
{
	...
	public class Behavior extends EventDispatcher implements IBehavior
	{
		...
		private var _thumb:anifire.browser.core.Thumb;
		...
		public function Behavior(param1:anifire.browser.core.Thumb, param2:String, param3:String, param4:int, param5:String, param6:String)
		{
			super();
			this.thumb = param1;
			this.id = param2;
		...
		public function get thumb() : anifire.browser.core.Thumb
		{
			return this._thumb;
		}
		
		public function set thumb(param1:anifire.browser.core.Thumb) : void
		{
			this._thumb = param1;
		}
