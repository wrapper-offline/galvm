package anifire.util.Crypto
{
	...
	public class FastRC4
	{
		...
		public function FastRC4(bytes:ByteArray = null)
		{
			super();
		...
		public function init(param1:ByteArray) : void
		{
			...
			while(_loc2_ < 256)
			{
				...
				_loc3_ = _loc3_ + this.S[_loc2_] + param1[_loc5_] & 0xFF;
		...
		public function encrypt(param1:ByteArray) : void
		{
			...
			while(_loc2_ < _loc4_)
			{
				...
				_loc3_ = int(this.S[this.i]);
				this.S[this.i] = this.S[this.j];
				this.S[this.j] = _loc3_;
				var _loc5_:Number;
				param1[_loc5_ = _loc2_++] = param1[_loc5_] ^ this.S[_loc3_ + this.S[this.i] & 0xFF];
			}
		}
