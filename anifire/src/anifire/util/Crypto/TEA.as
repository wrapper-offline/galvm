	...
	public class TEA
	{
		...
		public static function encrypt(param1:String, param2:String) : String
		{
			...
			while(_loc12_-- > 0)
			{
				...
				while(_loc6_ < _loc5_ - 1)
				{
					...
					_loc7_ = Number(_loc3_[_loc6_] = _loc3_[_loc6_] + _loc10_);
					_loc6_++;
				}
				_loc8_ = Number(_loc3_[0]);
				_loc10_ = (_loc7_ >>> 5 ^ _loc8_ << 2) + (_loc8_ >>> 3 ^ _loc7_ << 4) ^ (_loc13_ ^ _loc8_) + (_loc4_[_loc6_ & 3 ^ _loc11_] ^ _loc7_);
				_loc7_ = Number(_loc3_[_loc5_ - 1] = _loc3_[_loc5_ - 1] + _loc10_);
			}
		...
		public static function decrypt(param1:String, param2:String) : String
		{
			...
			while(_loc13_ != 0)
			{
				...
				while(_loc6_ > 0)
				{
					_loc7_ = Number(_loc3_[_loc6_ - 1]);
					_loc10_ = (_loc7_ >>> 5 ^ _loc8_ << 2) + (_loc8_ >>> 3 ^ _loc7_ << 4) ^ (_loc13_ ^ _loc8_) + (_loc4_[_loc6_ & 3 ^ _loc11_] ^ _loc7_);
					_loc8_ = Number(_loc3_[_loc6_] = _loc3_[_loc6_] - _loc10_);
					_loc6_--;
				}
				_loc7_ = Number(_loc3_[_loc5_ - 1]);
				_loc10_ = (_loc7_ >>> 5 ^ _loc8_ << 2) + (_loc8_ >>> 3 ^ _loc7_ << 4) ^ (_loc13_ ^ _loc8_) + (_loc4_[_loc6_ & 3 ^ _loc11_] ^ _loc7_);
				_loc8_ = Number(_loc3_[0] = _loc3_[0] - _loc10_);
				_loc13_ -= _loc9_;
			}
		...
		private static function longsToChars(param1:Array) : Array
		{
			...
			{
				_loc2_.push(param1[_loc3_] & 0xFF,param1[_loc3_] >>> 8 & 0xFF,param1[_loc3_] >>> 16 & 0xFF,param1[_loc3_] >>> 24 & 0xFF);
				_loc3_++;
			}
			return _loc2_;
		}
		...
		{
			var _loc2_:Array = new Array();
			_loc2_.push(param1 & 0xFF,param1 >>> 8 & 0xFF,param1 >>> 16 & 0xFF,param1 >>> 24 & 0xFF);
			return _loc2_;
		}
