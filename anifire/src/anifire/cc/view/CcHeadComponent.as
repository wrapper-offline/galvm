package anifire.cc.view
{
	...
	public class CcHeadComponent extends MovieClip
	{
		...
		protected var _componentList:UtilHashArray = new UtilHashArray();

		private var _charXml:XML;

		private var _sceneId:String;

		private var _assetImageIdArray:UtilHashArray = new UtilHashArray();

		private var _useImageLibrary:Boolean = false;

		private var _state:String;

		private var _containers:UtilHashArray = new UtilHashArray();
		...
		protected function setColors() : void
		{
			...
			if(this._charXml)
			{
				...
				{
					_loc2_ = new SelectedColor(_loc1_.@r,String(_loc1_.@oc).length == 0 ? uint.MAX_VALUE : uint(_loc1_.@oc),uint(_loc1_));
